...
export default function EditProjectModal({
      ...
      try {
        ...
        if (res.ok) {
          const filtered = data.data.users.filter(
            (u: User) => !initialMembers.some((m) => m.user.id === u.id)
          );
          setResults(filtered);
        }
      } catch {
  ...
  const contributors = initialMembers.filter((m) => m.role !== "OWNER");
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="edit-project-name" className="text-sm font-medium text-text-primary">
          ...
          {/* Description */}
          <div className="flex flex-col gap-1">
            <label htmlFor="edit-project-description" className="text-sm font-medium text-text-primary">
              Description
            </label>
            <textarea
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="edit-contributor-search" className="text-sm font-medium text-text-primary">
